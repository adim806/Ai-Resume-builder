...
const ProfessionalTemplatePDF = ({ data, accentColor }) => {
    ...
    const parseHtmlContent = (html) => {
        ...
        // TipTap wraps list items in <p> — unwrap first to avoid double line breaks between bullets
        content = content.replace(/<li[^>]*>\s*<p[^>]*>/gi, '|||LI|||');
        content = content.replace(/<\/p>\s*<\/li>/gi, '');
