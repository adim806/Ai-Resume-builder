...
const Feature = () => {
  ...
  return (
    <div id='features' className='flex flex-col items-center scroll-mt-12 bg-gradient-to-b from-white to-blue-50 text-slate-900 py-3'>
            ...
            <Title title='Build your resume' description='Our streamlined process helps yoy create a professional resume in minutes with intelligent AI-powered tools and features.'/>
